...
Adds cross-agent integration coverage ensuring delegated boundary policy enforcement behaves consistently across agent-normal/agent-companion/agent-pi for owner services (workspace-core + pty-service) when  is present.
