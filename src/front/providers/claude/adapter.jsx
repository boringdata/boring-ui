/**
 * Claude Code chat provider adapter.
 *
 * Wraps the existing ClaudeStreamChat component with session management
 * (tabs, add/close/switch sessions). Extracted from TerminalPanel.
 */
...
export default function ClaudeAdapter({ onToggleCollapse, approvals, onFocusReview, onDecision, normalizeApprovalPath }) {
  const config = useConfig()
  const chatInterface = config.chat?.interface || 'web'
