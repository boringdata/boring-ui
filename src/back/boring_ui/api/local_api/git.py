"""Local API git operations (bd-1adh.2.1).

Provides workspace-scoped git access:
...
def create_git_router(workspace_root: Path) -> APIRouter:
    """Create router for git operations.
    ...
    Args:
        workspace_root: Root path for git operations
    ...
    def run_git(args: list[str]) -> str:
        """Run a git command in the workspace context.
        ...
        Raises:
            HTTPException: 500 if git command fails
        """
